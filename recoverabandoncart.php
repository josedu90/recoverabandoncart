...
if (!class_exists('RecoverAbandonCart')) {
    ...
    final class RecoverAbandonCart {
        ...
        public function fp_rac_include_frontend_files() {
            ...
            include_once 'inc/frontend/class-fp-rac-unsubscribe-function.php';
            include_once 'inc/frontend/class-fp-rac-cart-data-from-mail.php';
            include_once 'inc/frontend/class-fp-rac-lightbox-handler.php';
            include_once 'inc/frontend/class-fp-rac-frontend-notice-handler.php';
        }
