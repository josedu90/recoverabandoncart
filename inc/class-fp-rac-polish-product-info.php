...
if ( ! class_exists( 'FP_RAC_Polish_Product_Info' ) ) {
    ...
    class FP_RAC_Polish_Product_Info {
        ...
        public static function fp_rac_extract_cart_details( $each_cart , $fp_rac_mail_purpose ) {
            ...
            ?>
            <table class="<?php echo $class_name ?> rac_product_info_tb" cellspacing="0" cellpadding="6" style="width: <?php echo $width ?>; font-family: 'Helvetica Neue', 'Helvetica', 'Roboto', 'Arial', 'sans-serif';"<?php echo $border ?> >
                <thead>
                ...
                <?php if ( get_option( 'rac_hide_tax_total_product_info_shortcode' ) != 'yes' ) { ?>
                    <tfoot>
                        <tr>
                            <?php $i = 1 ; ?>
                            <th class="<?php echo $class_name ?>" scope="row" colspan="<?php echo fp_rac_get_column_span_count() ; ?>" style="text-align:left; <?php if ( $i == 1 ) echo 'border-top-width: ' . $border_top_width . ';' ; ?>"><?php echo fp_get_wpml_text( 'rac_product_info_subtotal' , $lang , get_option( 'rac_product_info_subtotal', 'Subtotal' ) , 'admin_texts_rac_product_info_subtotal' ) ; ?></th>
                            <td class="<?php echo $class_name ?>" style="text-align:left; <?php if ( $i == 1 ) echo 'border-top-width: ' . $border_top_width . ';' ; ?>"><?php echo fp_rac_format_price( $subtotal , $curreny_code , '' , $each_cart ) ; ?></td>
                        </tr>
                        ...
                        <?php if ( ! empty( $total_coupon ) ) { ?>
                            <tr>
                                ...
                                $coupon_value   = ($total_coupon[ 'coupon_type' ] == 'percent') ? $total_coupon[ 'coupon_value' ] . '%' : fp_rac_format_price( $total_coupon[ 'coupon_value' ] , $curreny_code , '' , $each_cart ) ;
                                ?>
                        ...
                        <?php if ( $shipping_check ) { ?>
                            <tr>
                                <?php $i = 1 ; ?>
                                <th class="<?php echo $class_name ?>" scope="row" colspan="<?php echo fp_rac_get_column_span_count() ; ?>" style="text-align:left; <?php if ( $i == 1 ) echo 'border-top-width: ' . $border_top_width . ';' ; ?>"><?php echo fp_get_wpml_text( 'rac_product_info_shipping' , $lang , get_option( 'rac_product_info_shipping', 'Shipping' ) , 'admin_texts_rac_product_info_shipping' ) ; ?></th>
                        ...
                        <?php if ( $tax_check ) { ?>
                            <tr>
                                ...
                                $i = 1 ;
                                ?>
                                <th class="<?php echo $class_name ?>" scope="row" colspan="<?php echo fp_rac_get_column_span_count() ; ?>" style="text-align:left; <?php if ( $i == 1 ) echo 'border-top-width: ' . $border_top_width . ';' ; ?>"><?php echo fp_get_wpml_text( 'rac_product_info_tax' , $lang , get_option( 'rac_product_info_tax', 'Tax' ) , 'admin_texts_rac_product_info_tax' ) ; ?></th>
                                <td class="<?php echo $class_name ?>" style="text-align:left; <?php if ( $i == 1 ) echo 'border-top-width: ' . $border_top_width . ';' ; ?>"><?php echo fp_rac_format_price( $tax_total , $curreny_code , '' , $each_cart ) ; ?></td>
                            </tr>
                        <?php } ?>
                        <tr>
                            <?php $i = 1 ; ?>
                            <th class="<?php echo $class_name ?>" scope="row" colspan="<?php echo fp_rac_get_column_span_count() ; ?>" style="text-align:left; <?php if ( $i == 1 ) echo 'border-top-width: ' . $border_top_width . ';' ; ?>"><?php echo fp_get_wpml_text( 'rac_product_info_total' , $lang , get_option( 'rac_product_info_total', 'Total' ) , 'admin_texts_rac_product_info_total' ) ; ?></th>
                            <td class="<?php echo $class_name ?>" style="text-align:left; <?php if ( $i == 1 ) echo 'border-top-width: ' . $border_top_width . ';' ; ?>"><?php echo fp_rac_format_price( ($subtotal + $tax_total + $shipping_total ) , $curreny_code , '' , $each_cart ) ; ?></td>
                        </tr>
                        <?php
                        if ( class_exists( 'SUMOPaymentPlans' ) ) {
                            ...
                            if ( $sumo_pp_balance_payable ) {
                                ...
                                <tr>
                                    ...
                                    <td class="<?php echo $class_name ?>" style="text-align:left; <?php if ( $i == 1 ) echo 'border-top-width: ' . $border_top_width . ';' ; ?>"><?php echo fp_rac_format_price( ($sumo_pp_balance_payable ) , $curreny_code , '' , $each_cart ) ; ?></td>
                                </tr>
                                <?php
                            }
                        }
        ...
        public static function fp_rac_get_shipping_details( $total , $method_title , $shipping_tax_cost , $curreny_code , $each_cart) {
            if ( $total > 0 ) {
                ...
                return $method_title . ': ' . fp_rac_format_price( $total , $curreny_code , '' , $each_cart) ;
            } else {
                return $method_title ;
            }
        }
