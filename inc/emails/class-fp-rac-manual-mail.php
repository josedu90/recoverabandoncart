                ...
                foreach ($row_id_array as $row_id) {
                    ...
                    if (is_object($each_cart)) {
                        ...
                        if ($check_email_restrict && $check_unsub_restrict) {
                            ...
                            $message = shortcode_in_subject($firstname, $lastname, $message, $email_old_template_id, $each_cart); // added shortcode replacing from subject content to message content
