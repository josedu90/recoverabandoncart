...
if (!class_exists('FP_RAC_Submenu')) {
    ...
    class FP_RAC_Submenu {
        ...
        public static function fprac_admin_settings() {
            ...
            //display cartlist entry restriction warning message.
            echo self::display_cartlist_entry_restriction_message();
        ...
        public static function display_cartlist_entry_restriction_message() {
          ...
          if($user_permission != 'yes'){
            ...
            <div id='message' class='error'>
                <p>
                    <strong><?php _e("Automatic Abandoned Cart capture has been Disabled for Members!!!", 'recoverabandoncart') ?></strong>
                </p>
            </div>
            <?php
          }
          if($guest_permission != 'yes'){
              ?>
            <div id='message' class='error'>
                <p>
                    <strong><?php _e("Automatic Abandoned Cart capture has been Disabled for Guests!!!", 'recoverabandoncart') ?></strong>
                </p>
            </div>
              <?php
          }
