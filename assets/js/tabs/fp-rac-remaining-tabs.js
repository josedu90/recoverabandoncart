    ...
    var Remaining_tabs = {
        ...
        initialize_select_event: function () {
            if (fp_rac_remaining_tabs_obj.rac_wc_version <= parseFloat('2.2.0')) {
                ...
                $('#rac_user_pages_for_disp_notice').chosen();
                $('#rac_guest_pages_for_disp_notice').chosen();
                ...
                $('#rac_menu_disp_user_roles').chosen();
            } else {
                $('#rac_template_seg_selected_user_role').select2();
                $('#custom_user_role').select2();
                $('#rac_user_pages_for_disp_notice').select2();
                $('#rac_guest_pages_for_disp_notice').select2()
                ...
                $('#rac_menu_disp_user_roles').select2();
            }
        },
    };
    Remaining_tabs.init();
